...
go run ./hostfunc_patch/hostfunc_patch.go -in mod/unbundled-module0-patched.wat -out /tmp/unbundled-module0-patched-2.wat -funs hostFuncPrintk,hostFuncLenInputBuf,hostFuncReadValue
